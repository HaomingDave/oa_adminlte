...
<script>
    ...
    function initializeTable(cat,pro,key) {
        var table = $('#example2').DataTable({
            ...
            "processing": true,
            "ajax":{
                "url":getCookie("pmServer")+"/api/1.0/workflow/cases/draft/paged?cat_uid="+cat+"&pro_uid="+pro+"&search="+key,
    ...
    var initializefilter = function (){
        ...
        pmRestRequest("GET","/api/1.0/workflow/cases/draft/paged",false,null,function(data, status){
