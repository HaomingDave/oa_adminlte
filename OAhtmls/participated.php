...
<script>
    ...
    function initializeTable(cat,pro,key) {
         var table = $('#example2').DataTable({
            ...
            "processing": true,
            "ajax":{
                "url":getCookie("pmServer")+"/api/1.0/workflow/cases/participated/paged?cat_uid="+cat+"&pro_uid="+pro+"&search="+key,
        ...
        $('.openbtn').click(function(){
            ...
            location.href="casedetail.php?app_uid=" + caseid.app_uid;
        });
    ...
    var initializefilter = function (){
      ...
      pmRestRequest("GET","/api/1.0/workflow/cases/participated/paged",false,null,function(data, status){
